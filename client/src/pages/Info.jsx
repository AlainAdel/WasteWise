...
const Info = () => {
  return (
    <div className="montserrat-regular bg-black text-white min-h-screen px-6 py-10 max-w-4xl mx-auto space-y-10">
      <h1 className="text-blue-400 text-4xl text-center">
        About WasteWise
      </h1>

      {/* What is WasteWise */}
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">What is WasteWise?</h2>
      ...
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">How Classification Works</h2>
        <p className="text-gray-300 font-mono">
      ...
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">Supported Waste Types</h2>
      ...
      {/* Facility Matching */}
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">Facility Matching</h2>
        <p className="text-gray-300 font-mono">
      ...
      {/* Privacy */}
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">Privacy & Data</h2>
        <p className="text-gray-300 font-mono">
      ...
      {/* FAQs */}
      <section>
        <h2 className="text-2xl text-blue-300 mb-2">FAQs</h2>
